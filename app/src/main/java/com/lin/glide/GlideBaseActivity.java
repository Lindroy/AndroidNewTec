...
public class GlideBaseActivity extends Activity {
    ...
    private void initData() {
        ...
        Glide.with(this).load(R.drawable.qq).into(ivGlide2);
        ...
        //发现GIF图片放在drawable文件夹（后面没有限定像素）下才起作用
        ...
        Glide.with(this).load(new File(urlPath)).thumbnail(0.1f)//表示是原来的0.1倍
                .centerCrop().placeholder(R.mipmap.ic_launcher).into(ivGlide8);
